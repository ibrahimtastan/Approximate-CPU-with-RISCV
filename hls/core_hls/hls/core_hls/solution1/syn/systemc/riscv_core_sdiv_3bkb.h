...
#ifndef __riscv_core_sdiv_3bkb__HH__
#define __riscv_core_sdiv_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(riscv_core_sdiv_3bkb) {
    ...
    SC_CTOR(riscv_core_sdiv_3bkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
