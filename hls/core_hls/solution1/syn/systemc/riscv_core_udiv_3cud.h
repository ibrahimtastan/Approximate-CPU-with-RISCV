...
#ifndef __riscv_core_udiv_3cud__HH__
#define __riscv_core_udiv_3cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(riscv_core_udiv_3cud) {
    ...
    SC_CTOR(riscv_core_udiv_3cud):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
